...
public class DocumentsApi {
    ...
    /** Restore document */
    public PlusApiResultDocumentOperationVO restoreDocument(String documentId) throws Exception {
        return (PlusApiResultDocumentOperationVO) client.put(ApiPaths.appPath("/documents/" + documentId + "/restore"), null);
    }
    ...
    /** Archive document */
    public PlusApiResultDocumentOperationVO archiveDocument(String documentId) throws Exception {
        return (PlusApiResultDocumentOperationVO) client.put(ApiPaths.appPath("/documents/" + documentId + "/archive"), null);
    }
    ...
    /** Favorite document */
    public PlusApiResultDocumentOperationVO favoriteDocument(String documentId) throws Exception {
        return (PlusApiResultDocumentOperationVO) client.post(ApiPaths.appPath("/documents/" + documentId + "/favorite"), null);
    }

    /** Unfavorite document */
    public PlusApiResultDocumentOperationVO unfavoriteDocument(String documentId) throws Exception {
        return (PlusApiResultDocumentOperationVO) client.delete(ApiPaths.appPath("/documents/" + documentId + "/favorite"));
    }
    ...
    public PlusApiResultDocumentOperationVO batchDelete() throws Exception {
        return (PlusApiResultDocumentOperationVO) client.delete(ApiPaths.appPath("/documents/batch-delete"));
    }

    /** Batch delete documents */
    public PlusApiResultDocumentOperationVO deleteBatch() throws Exception {
        return (PlusApiResultDocumentOperationVO) client.delete(ApiPaths.appPath("/documents/batch"));
    }
}
