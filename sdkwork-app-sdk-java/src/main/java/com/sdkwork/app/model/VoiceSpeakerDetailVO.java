...
public class VoiceSpeakerDetailVO {
    ...
    private List<VoiceSourceVO> voiceSources;
    private List<String> sampleAudios;
    ...
    public List<VoiceSourceVO> getVoiceSources() {
        return this.voiceSources;
    }
    
    public void setVoiceSources(List<VoiceSourceVO> voiceSources) {
        this.voiceSources = voiceSources;
    }

    public List<String> getSampleAudios() {
        return this.sampleAudios;
    }
    
    public void setSampleAudios(List<String> sampleAudios) {
        this.sampleAudios = sampleAudios;
    }
