...
- Domain: app
- Language: java
- SDK package: `sdkwork-app-sdk-java`
...
- Local integration: `mvn install:install-file -Dfile=<path-to-jar> -DgroupId=com.sdkwork -DartifactId=app-sdk -Dversion=1.0.0 -Dpackaging=jar`
