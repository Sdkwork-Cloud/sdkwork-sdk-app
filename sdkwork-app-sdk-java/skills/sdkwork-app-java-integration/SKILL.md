---
name: sdkwork-app-java-integration
description: Use when integrating the sdkwork-app-sdk-java package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-app-sdk-java` into an application using progressive stages. Advance only when the current stage exits green.
...
- Registry integration: `mvn dependency:get -Dartifact=com.sdkwork:app-sdk:1.0.0`
- Local-path integration: `mvn install:install-file -Dfile=<path-to-jar> -DgroupId=com.sdkwork -DartifactId=app-sdk -Dversion=1.0.0 -Dpackaging=jar`
