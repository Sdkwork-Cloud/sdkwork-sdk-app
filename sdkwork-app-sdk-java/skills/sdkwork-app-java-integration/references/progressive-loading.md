...
- Registry command: `mvn dependency:get -Dartifact=com.sdkwork:app-sdk:1.0.0`
- Local command: `mvn install:install-file -Dfile=<path-to-jar> -DgroupId=com.sdkwork -DartifactId=app-sdk -Dversion=1.0.0 -Dpackaging=jar`
