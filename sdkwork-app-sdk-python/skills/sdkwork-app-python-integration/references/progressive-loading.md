...
- Registry command: `pip install sdkwork-app-sdk==1.0.0`
- Local command: `pip install <path-to-sdkwork-app-sdk-python>`
- Verification: `python -m pip show sdkwork-app-sdk`
- [ ] Dependency resolved
- [ ] Metadata updated
- [ ] Verification passed
