---
name: sdkwork-app-python-integration
description: Use when integrating the sdkwork-app-sdk-python package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-app-sdk-python` into an application using progressive stages. Advance only when the current stage exits green.
...
- Registry integration: `pip install sdkwork-app-sdk==1.0.0`
- Local-path integration: `pip install <path-to-sdkwork-app-sdk-python>`
...
- `python -m pip show sdkwork-app-sdk`
