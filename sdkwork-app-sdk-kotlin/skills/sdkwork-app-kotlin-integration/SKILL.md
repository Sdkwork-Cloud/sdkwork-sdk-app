---
name: sdkwork-app-kotlin-integration
description: Use when integrating the sdkwork-app-sdk-kotlin package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-app-sdk-kotlin` into an application using progressive stages. Advance only when the current stage exits green.
...
- Registry integration: `implementation("com.sdkwork:app-sdk:1.0.0")`
- Local-path integration: `implementation(files("<path-to-sdkwork-app-sdk-kotlin/build/libs/*.jar"))`
