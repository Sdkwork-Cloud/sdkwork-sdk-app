---
name: sdkwork-app-flutter-integration
description: Use when integrating the sdkwork-app-sdk-flutter package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-app-sdk-flutter` into an application using progressive stages. Advance only when the current stage exits green.
...
- SDK coordinate: `app_sdk@1.0.0`
- Registry integration: `flutter pub add app_sdk`
- Local-path integration: `flutter pub add app_sdk --path <path-to-sdkwork-app-sdk-flutter>`
