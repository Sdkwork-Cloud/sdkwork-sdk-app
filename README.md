...
- TypeScript: default npm dependency `@sdkwork/sdk-common`, with optional git source switch via `sdkwork-app-sdk-typescript/package.json` scripts.
...
```bash
cd spring-ai-plus-app-api/sdkwork-sdk-app/sdkwork-app-sdk-typescript
./bin/publish.sh --action check
./bin/publish.sh --action publish --channel release
```

```powershell
cd spring-ai-plus-app-api/sdkwork-sdk-app/sdkwork-app-sdk-java
...
- Verify your running endpoint first: `http://localhost:8080/v3/api-docs/app`.
