---
name: sdkwork-app-csharp-integration
description: Use when integrating the sdkwork-app-sdk-csharp package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-app-sdk-csharp` into an application using progressive stages. Advance only when the current stage exits green.
...
- Registry integration: `dotnet add package App --version 1.0.0`
- Local-path integration: `dotnet add <target.csproj> reference <path-to-sdkwork-app-sdk-csharp/App.csproj>`
