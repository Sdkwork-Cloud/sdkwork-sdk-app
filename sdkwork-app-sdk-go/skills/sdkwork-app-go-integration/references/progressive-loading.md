...
- Registry command: `go get github.com/sdkwork/app-sdk@v1.0.0`
- Local command: `go mod edit -replace github.com/sdkwork/app-sdk=<path-to-sdkwork-app-sdk-go> && go mod tidy`
