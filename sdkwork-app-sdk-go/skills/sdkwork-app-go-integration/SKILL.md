---
name: sdkwork-app-go-integration
description: Use when integrating the sdkwork-app-sdk-go package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-app-sdk-go` into an application using progressive stages. Advance only when the current stage exits green.
...
- Registry integration: `go get github.com/sdkwork/app-sdk@v1.0.0`
- Local-path integration: `go mod edit -replace github.com/sdkwork/app-sdk=<path-to-sdkwork-app-sdk-go> && go mod tidy`
