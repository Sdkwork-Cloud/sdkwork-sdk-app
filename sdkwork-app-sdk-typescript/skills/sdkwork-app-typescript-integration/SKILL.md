---
name: sdkwork-app-typescript-integration
description: Use when integrating the sdkwork-app-sdk-typescript package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-app-sdk-typescript` into an application using progressive stages. Advance only when the current stage exits green.
